...
namespace FrbaOfertas.AbmProveedor
{
    public partial class Form1 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            query.CommandText = "SELECT id,RS,dom,ciudad,telefono,CUIT,mail,codigoPostal,(SELECT nombre FROM LOS_SIN_VOZ.Rubro WHERE id=rubro) AS rubro,contacto FROM LOS_SIN_VOZ.Proveedor ";
